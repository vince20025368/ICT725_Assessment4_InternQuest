...
class CybersecurityQuestions extends StatelessWidget {
  final Map<String, List<String>> questions = {
    ...
    'Behavioural Questions': [
      ...
      'What’s your process for conducting a security audit?',
    ],
    'Situational Questions': [
      'You discover a zero-day vulnerability in production. What’s your immediate response?',
      'You’re tasked with designing a secure login system for a mobile app. What features do you include?',
    ],
  };
