...
class ProfileApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: ProcterGambleInternship(),
      debugShowCheckedModeBanner: false,
    );
  }
}

class ProcterGambleInternship extends StatelessWidget {
  final String logo = "Internquest";
  final String userName = 'Vince Atienza';
  final String userEmail = '20025368@gmail.com';
  final String company = 'Procter and Gamble Australia';
  final String jobTitle = 'Quality Assurance Tester';
  ...
  final List<Map<String, dynamic>> stages = [
    ...
    {'label': 'Decision', 'color': Colors.grey},
  ];
