...
class ProfileApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: IntuitInternship(),
      debugShowCheckedModeBanner: false,
    );
  }
}

class IntuitInternship extends StatelessWidget {
  final String logo = "Internquest";
  final String userName = 'Vince Atienza';
  final String userEmail = '20025368@gmail.com';
  final String company = 'Intuit Australia';
  final String jobTitle = 'Software Developer Intern';
