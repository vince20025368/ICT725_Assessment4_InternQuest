...
class InternshipApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: McdonaldsApplication(),
    );
  }
}

class McdonaldsApplication extends StatelessWidget {
  final String email = 'careers@mcdonald.com.au';
  final String company = 'McDonalds';
  final String role = 'IT Infrastructure Intern';
  final String address = '501 Arrow Rd, Haymarket';
  final String status = 'N/A';
  final String profileImage = 'assets/images/mcdonalds.png';
  ...
  final List<String> responsibilities = [
    ...
    'Document and update IT asset inventory and configurations',
    'Help maintain user account and permissions across platforms',
    'Contribute to routine data backups and recovery procedures',
    'Participate in security audits and patch management initiatives',
  ];
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Description
              Text(
                'Join our dynamic tech team as an IT Infrastructure Intern, where you\'ll gain hands-on experience supporting the backbone of enterprise technology. This role is ideal for proactive learners eager to dive into system administration, network maintenance, and cloud-based operations.',
